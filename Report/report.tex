...
Den allmänna informationen i Twitters databas returneras som svar på HTTP-förfrågningar till URL:er som dokumenteras på Twitters hemsida. Svaren skickas i antingen XML- eller JSON-format, se sida~\pageref{sec:json}.
...
Den slutliga lösningen blev alternativ 2, eftersom att programloopen ska köras ofta och att millis redan är implementerad. Vidare valdes alternativ 1 bort eftersom att ATmega2560 endast har fyra 16-bitars timers vilka kan behövas i andra delar av programmet. Implementationen bryter mot DHCP specifikationen på några punkter:
...
HTTP-parsern fungerade till en början men slutade sedan att kompilera korrekt. Felsökning var för tidskrävande och för sent i projektet. Yajl använder ett antal konstanter som inte finns i AVR-C. Dessa fick definieras för hand med kvalificerade gissningar.

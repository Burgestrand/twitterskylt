...
Det färdiga systemet uppfyller alla de krav som uppställdes i projektets början, dessa återfinns i avdelningen \ref{sec:mal}. Både den önskade funktionaliteten och energieffektiviteten har uppnåtts, dock finns det brister gällande systemetsanvändarvänlighetet. I dagsläget är det opraktiskt att komma åt det micro-SD-kort på vilket systemets konfigurering ska sparas. Felhanteringen är också ytterst begränsad då basstationen endast signalerar om ett fel har inträffat, ej vilket slags fel. Dessa brister är dock i sammanhanget små och skulle i en slutlig design kunna åtgärdas utan att göra några grundläggande förändringar i systemets uppbyggnad.\\

...
För att avgöra hur energisnål displayen är jämförs den med LCD-displayer av konventionell typ. Se tabell \href[kenttable]. Den alfanumeriska displayen är av en enklare typ som dock klarar av att visa lika många tecken. Den grafiska displayen är av liknande storlek och upplösning som Kent-displayen.
...
\centering
    ...
    {\bf Modell} & {\bf Statisk förbrukning [mW]} & {\bf Förbrukning vid uppdatering [mW]} & {\bf Genomsnittsförbrukning} \\
    Kent & $0$ & $97$ & $0.41$ \\
...
Strömförbrukningsvärdena har hämtats från respektive displays datablad \href[lcdalfa]{(DISPLAY Elektronik, 2009)}, \href[lcdgraph]{(DISPLAY Elektronik, 2011)}. Kent-displayens genomsnittsförbrukning togs fram med antagandet att en uppdatering tar 1,27 sekunder, vilket anges som en typisk uppdateringstid vid rumstemperatur i displayens datablad \href[kent]{(Kent Displays Inc., 2010)}. Vi räknar med att uppdatering utförs var 5:e minut, den högsta uppdateringsfrekvensen som uppnås vid normalt användande av skylten {HÄNVISA TILL STYCKE DÄR DET ANGES?}.
...
\bibitem{arduino}
   Arduino,\\
   \emph{Arduino}.
   \url{http://www.arduino.cc/} (2012-01-19)\\
   \emph{Arduino Pro}.
   \url{http://arduino.cc/it/Main/ArduinoBoardPro} (2012-01-19)\\
   \emph{Arduino Mega}.
   \url{http://arduino.cc/it/Main/ArduinoBoardMega} (2012-01-19)\\
   \emph{XBee Shield}
   \url{http://arduino.cc/it/Main/ArduinoXbeeShield} (2012-01-24)\\
   \emph{Ethernet Shield}
   \url{http://arduino.cc/en/Main/ArduinoEthernetShield} (2012-01-19)
   2009-2012.
...
\bibitem{kent}
    ...
    2012. (2012-04-05) \\
    \emph{1/8 VGA Cholesteric Display Module with SPITM-Compatible Interface. Kent Displays | Resources.},
    \url{http://www.kentdisplays.com/services/resources/datasheets/25075h_240x160_SPI_datasheet.pdf}, 2012. (2012-03-31)

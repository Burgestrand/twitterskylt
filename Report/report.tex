...
\begin{figure}[H]
\includegraphics[scale=0.2, angle=0]{drawing_base.png}
\label{fig:drawing_base}
\caption{Basstation, sidovy}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=0.2, angle=0]{drawing_base_side.png}
\label{fig:drawing_base}
...
\begin{figure}[H]
\includegraphics[scale=0.2, angle=0]{drawing_skylt.png}
